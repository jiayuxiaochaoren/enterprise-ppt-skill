const BASE_RENDERER_CONTEXT_CONTRACT = {
  ...
  shapes: ['addRect', 'addHairline', 'addArrowLine', 'addArrowBetweenRects', 'addCardToCardConnector', 'addClockwiseLoopConnectors', 'PageNumber', 'lightCanvas', 'stageCanvas', 'addPhotoPanel', 'addSmartPhotoPanel', 'addDarkBreathingCircle', 'addLightBreathingCircle', 'addPulseCurve'],
