...
assert.ok(shapes.some(op => op.type === 'ellipse'), 'lightCanvas should add a canvas motif');
...
assert.equal(canvasMotifs.canvasMotifKind({ industry:'beauty-consumer' }, {}, 'light'), 'beauty-editorial-veil');
