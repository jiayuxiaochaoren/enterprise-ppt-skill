...
const TEST_GROUPS = {
  unit: [
    /^test_(chart_spec|closing_routing|content_signals|density_strategy|design_proof_profile|design_system_modules|design_text_utils|evidence_gallery_routing|financial_chart_utils|image_layout_strategy|metadata_policy|quality_mode|render_content_helpers|render_geometry|render_meta_audits|render_meta_schema|renderer_modularization|routing|typography_system|visual_qa_utils)\.js$/
  ],
  pipeline: [
