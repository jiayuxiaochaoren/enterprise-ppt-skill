...
const TEST_GROUPS = {
  unit: [
    /^test_(chart_spec|density_strategy|design_system_modules|image_layout_strategy|metadata_policy|quality_mode|render_meta_schema|renderer_modularization|routing|typography_system)\.js$/
  ],
  pipeline: [
