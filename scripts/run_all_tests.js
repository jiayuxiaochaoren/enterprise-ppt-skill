...
const TEST_GROUPS = {
  unit: [
    /^test_(chart_spec|density_strategy|design_proof_profile|design_system_modules|design_text_utils|image_layout_strategy|metadata_policy|quality_mode|render_content_helpers|render_geometry|render_meta_audits|render_meta_schema|renderer_modularization|routing|typography_system)\.js$/
  ],
  pipeline: [
