...
function chapterEditorialAgenda(slide, plan, s, idx) {
  ...
  addText(slide, s.title || '章节标题', { x:0.86, y:2.10, w:4.85, h:0.45, typeRole:'pageTitle', fontSize:22.5, bold:true, color:C.white, fit:'shrink', breakLine:true, fontFace:PROFILE.font });
...
function slideRenderRegistry() {
  ...
  const familyRenderers = Object.assign({},
    ...
    createEvidenceGalleryRenderers(rendererContext),
