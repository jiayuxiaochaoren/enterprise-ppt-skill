...
const TEST_PROFILE_RULES = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/(build_chart_regression_samples|build_reference_recipes|generate_industry_stress_demos|industry_acceptance_matrix|inspect_design|run_beauty_chart_benchmark|run_industry_acceptance)\.js$/,
