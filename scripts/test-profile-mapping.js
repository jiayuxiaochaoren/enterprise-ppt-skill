...
const TEST_PROFILE_RULES = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/test_(card_layout_helpers|chrome_helpers|closing_routing|evidence_gallery_routing|fallback_renderer|financial_chart_utils|light_chrome_texture|metadata_policy|metric_comparison_people_culture|people_culture_cover_renderer|risk_board_industry_variants|routing)\.js$/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/design\/asset-generation-prompt\.js$/,
      ...
      /^scripts\/test_asset_decision_meta\.js$/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/design\/layout-preflight\.js$/,
	      ...
	      /^scripts\/test_cross_industry_similarity_audit\.js$/,
