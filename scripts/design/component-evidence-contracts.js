...
const COMPONENT_EVIDENCE_CONTRACTS = {
  'adoption-funnel': ['adoptionFunnel', 'activationFunnel', 'cohortFunnel', 'funnel'],
  ...
  'caption-bar': [...IMAGE_FIELDS, ...STRUCTURED_SOURCE_FIELDS, 'caption', 'subtitle', 'claim', 'visual.caption', 'proof.explanation', 'editorialProof'],
  ...
  'contact-block': ['contact', 'contacts', 'owner', 'owners', 'organization', 'companyFacts', 'company', 'team'],
  'decision-panel': ['decision', 'decisions', 'actions', 'nextSteps', 'recommendation', 'summary', 'growth', 'metrics'],
  ...
  'information-gap': ['chartSpec.informationGap', 'informationGap', 'missingInfo'],
  ...
  'product-matrix': ['product', 'products', 'productStory', 'productItems', 'skuMatrix', 'editorialProof', 'cards', ...IMAGE_FIELDS, ...STRUCTURED_SOURCE_FIELDS],
