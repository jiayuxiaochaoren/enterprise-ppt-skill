...
function typographyRoot() {
  return VISUAL_SYSTEM.typography || {};
}
...
function typographyProfileFor(plan = {}) {
  const profiles = VISUAL_SYSTEM.typographyProfiles || {};
...
function typographyFontSet(plan = {}) {
  ...
  return Object.assign({
    cjk: FONT_STACK.zh || policy.cjk || 'PingFang SC',
    latin: FONT_STACK.latin || policy.latin || 'Avenir Next',
    number: FONT_STACK.number || policy.number || 'DIN Alternate',
